...
function cold_plasma_dispersion,epol=epol,freq=freq,dens=dens,Bo=Bo,H_plus=pH,He_plus=pHe,O_plus=pO
...
;-----------------------------------------------------------------------
  ...
  notes = ['freq in Hz','kmag in 1/km','theta_kb in deg','n=index of refraction',$
           'wavelength in km','resangle in deg','phasevel in km/sec',$
