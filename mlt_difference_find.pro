...
;****************************************************************
;***NOTE THAT I'VE WRITTEN A MUCH MORE EFFICIENT VERSION OF THIS
;CALLED calculate_angle_difference.pro. I'M LEAVING THIS HERE
;FOR LEGACY REASONS.
;****************************************************************
...
pro mlt_difference_find,tname1,tname2
  ...
  store_data,'delta_mlt',data={x:m1t.x,y:dmlt_fin}
